...
public class Order {
    ...
    public void confirm() {
        ...
        DateTimeSource source = DateTimeSourceFabric.getTimeSource( "RT" );
        DateTime time = source.getDateTime();
        int hoursElapsedAfterSubmittion = Hours.hoursBetween( subbmitionDate, time ).getHours();
